            ...
            <ul class="letter-list">
                <#list conversations as con>
                    ...
                    <div class="letter-info">
                        <span class="l-time">${con.conversation.createdDate?string("yyyy-MM-dd HH:mm:ss")!}</span>
                    ...
                    <div class="chat-headbox">
                        ...
                        <a class="list-head" href="/user/${con.user.id!}">
                            <img alt="头像" src="${con.user.headUrl!}">
                        </a>
                    </div>
                    <div class="letter-detail">
                        <a title="${con.user.name!}" class="letter-name level-color-1">
                            ${con.user.mame!}
                        </a>
